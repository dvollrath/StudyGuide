...
comp <- p[which(p$countrycode %in% c("USA","CHN","KOR")),]
...
fig <- plot_ly(usa, x = ~year, y = ~lngdppc, linetype = ~countrycode, type = 'scatter', mode = 'lines+markers')
...
fig <- plot_ly(deu, x = ~year, y = ~lngdppc, linetype = ~countrycode, type = 'scatter', mode = 'lines+markers')
...
fig <- plot_ly(kor, x = ~year, y = ~lngdppc, linetype = ~countrycode, type = 'scatter', mode = 'lines+markers')
...
fig <- plot_ly(kor, x = ~year, y = ~csh_i, linetype = ~countrycode, type = 'scatter', mode = 'lines+markers')
...
fig <- plot_ly(chn, x = ~year, y = ~lngdppc, linetype = ~countrycode, type = 'scatter', mode = 'lines+markers')
fig <- fig %>% add_trace(y = ~fitted1, name = 'BGP before',mode = 'lines')
...
fig <- plot_ly(chn, x = ~year, y = ~csh_i, linetype = ~countrycode, type = 'scatter', mode = 'lines+markers')
...
#########################################################################
f <- p[which(p$countrycode %in% c("CHN")),] # re-grab initial data
...
fig <- plot_ly(f, x = ~year, y = ~lntfp, linetype = ~countrycode, type = 'scatter', mode = 'lines+markers')
...
#########################################################################
f <- p[which(p$countrycode %in% c("JPN")),]
