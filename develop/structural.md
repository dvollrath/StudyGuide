...
{: .fact}
> Services tend to have higher output per worker than manufacturing, and manufacturing tends to have higher output per worker than Extraction. This isn't universally true for all countries and all time periods.
