...
Go back to [this section](capital.html) and recall that we could write the level of GDP per capita as
...
The best way to see the impact of all these parameters on the level of the BGP is to play with this.
...
<iframe width="900" height="600" frameborder="0" scrolling="no" src="../plotly/pwt-corr-si.html"></iframe>
...
<iframe width="900" height="600" frameborder="0" scrolling="no" src="../plotly/pwt-corr-gl.html"></iframe>
