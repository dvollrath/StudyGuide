...
You can also play with the following app, and it allows you to tweak the parameters of the model and see how various outcomes evolve over time. In essence, this is an interactive version of the spreadsheet that is easier to adjust, but remember it is doing exactly the *same* thing. You can play with the embedded app below, or use [this link](https://dietzvollrath.shinyapps.io/TestBasic/) to open up a direct link, which is easier to use.
